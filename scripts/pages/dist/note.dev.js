...
document.addEventListener("keydown", function (event) {
  ...
  var keyCode = event.keyCode; // Gérer la navigation en fonction de la touche pressée
...
function moveFocus(direction) {
  ...
  var interactiveElements = document.querySelectorAll("article"); // Trouver l'élément actuellement focalisé

  var currentElement = document.activeElement;
  var currentIndex = Array.from(interactiveElements).indexOf(currentElement); // Déplacer le focus vers l'élément précédent ou suivant
  ...
  interactiveElements[newIndex].classList.add("active"); // Déplacer le focus
